...
document.addEventListener('DOMContentLoaded', function() {
    const animatedElements = document.querySelectorAll('.program-card, .support-card, .story-card, .impact-stat');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    startJourneyBtns.forEach(btn => {
        btn.addEventListener('click', function() {
            alert('Welcome to WellnessHub! This would redirect to the registration page.');
        });
    });
    ...
    joinGroupBtns.forEach(btn => {
        btn.addEventListener('click', function() {
            const groupType = this.classList.contains('red') ? 'Smoking Cessation' : 'Alcohol Recovery';
            alert(`Thank you for your interest in joining the ${groupType} group! This would redirect to the group registration page.`);
        });
    });
    ...
    learnMoreLinks.forEach(link => {
        link.addEventListener('click', function(e) {
            ...
            alert(`Learn more about our ${programName} program! This would redirect to the detailed program page.`);
        });
    });
});
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const cards = document.querySelectorAll('.program-card, .support-card, .story-card');
...
const first = drawer.querySelector('a, button, select, input, textarea, [tabindex]:not([tabindex="-1"])');
